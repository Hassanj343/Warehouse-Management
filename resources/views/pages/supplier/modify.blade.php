...
@section('curr-page')supplier-create @stop
    ...
    <div class="tray tray-center p25 va-t posr">
        ...
        <div class="panel panel-danger panel-border top lighter animated fadeIn" id="panelUser">
            <div class="panel-heading">
                <span class="panel-title" id="panel-title">Update Supplier</span>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="{{ route('post-modify-supplier',$data->id) }}"
                      id="createSupplier"
                      method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label for="name" class="col-md-12">Supplier Name</label>
                    ...
                    <div class="text-center col-md-12 mt20">
                        ...
                        <a href="{{ route('delete-supplier',$data->id) }}"
                           class="btn btn-lg btn-danger btn-rounded ml20" id="deleteSupplier">
                            <span class="fa fa-times mr10"></span>
                            <span id="btnText">Delete Supplier</span>
                        </a>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#deleteSupplier').click(function (e) {
                ...
                swal({
                    title: "Are you sure?",
                    text: "Are you sure you want to delete this supplier. Warning data will be permanently deleted?",
                    type: "warning",
