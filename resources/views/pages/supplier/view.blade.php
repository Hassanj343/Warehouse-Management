...
@section('curr-page')supplier-view @stop
        ...
        <div class="panel">
            ...
            <div class="panel-body pn">
                <div class="col-lg-12 text-right mt10">
                    <a href="{{ route('modify-supplier',$data->id) }}" class="btn btn-primary">
                        <i class="fa fa-pencil mr10"></i>
                        Modify Supplier
                    </a>
                    <a href="{{ route('delete-supplier',$data->id) }}" class="btn btn-danger" id="deleteBtn">
        ...
        <div class="panel">
            ...
            <div class="panel-body pn">
                <table class="table admin-form theme-warning tc-checkbox-1 fs14 text-left" id="dataTable">
                    ...
                    <tbody>
                    @foreach($data->getProducts as $key => $val)
                        <tr>
