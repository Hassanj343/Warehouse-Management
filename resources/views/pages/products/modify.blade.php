...
@section('curr-page')products-modify @stop

@section('content')
        <!-- Begin: Content -->
<?php
$purchase_price = (double) $data['price']['purchase_price'];
$sale_price = (double) $data['price']['sale_price'];
?>
    ...
    <div class="tray tray-center p25 va-t posr">
        ...
        <div class="panel panel-danger panel-border top lighter animated fadeIn" id="panelUser">
            <div class="panel-heading">
                <span class="panel-title" id="panel-title">Modify Product</span>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="{{ route('post-modify-product',$data['id']) }}"
                      id="createProduct" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    ...
                                    <input autocomplete="off"
                                           ...
                                           type="text"
                                           value="{{ formatCurrency($purchase_price) }}"/>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    ...
                                    <input autocomplete="off"
                                           ...
                                           type="text"
                                           value="{{ $data['warning']['warning_3'] }}"/>
                                </div>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="image" class="col-md-12">Image url</label>
                                ...
                                <div class="">
                                    <select name="group" class="form-control" id="group" tabindex="4">
                                        ...
                                        @foreach(\App\Models\Group::all() as $key => $group)
                                            <option {{ ($group->id == $data['group_id'] ) ? 'selected' : '' }}
                                                    value="{{ $group->id }}">
                                                {{$group->name}}
                                            </option>
                                        @endforeach
...
@section('custom-js')
    ...
    <script type="text/javascript" src="{{ asset('assets/admin-tools/admin-forms/js/jquery.maskedinput.js') }}"></script>
    <script>
