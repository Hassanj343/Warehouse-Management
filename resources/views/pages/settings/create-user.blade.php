    ...
    <div class="tray tray-center p25 va-t posr">
        ...
        <div class="panel panel-info panel-border top darker animated fadeIn" id="panelUser">
            <div class="panel-heading">
                <span class="panel-title" id="panel-title">Create User</span>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" method="post" action="{{ route('post-settings-create-user') }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 field select">
                            <select class="form-control" name="role" id="">
                                ...
                                <option id="user" selected value="user">User</option>
                            </select>
